...
/**
 * Thrown during template if a problem arises during
 * initialisation of the configuration 'template.xml' file.
 *
 * @author Michael O'Connor - Finalist IT Group
 */
public class TemplateConfigException extends Exception {
